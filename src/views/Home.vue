<template>
  <main v-if="!loading" class="text-gray-700">
    <DataTitle :text="title" :dataDate="dataDate" />
   
    <div class="flex flex-col justify-center mx-5 sm:mx-0">
      <CountrySelect @get-country="getCountryData" :countries="countries" />
      <button 
        type="button"
        v-if="stats.Country" @click="clearCountryData"
        class="inline-block w-full px-6 py-2 leading-tight uppercase transition duration-150 ease-in-out border border-gray-500 rounded shadow hover:bg-green-50 hover:border-green-600"
        >
        Clear Country
      </button>
    </div>
    ...
    <div class="flex items-center justify-center mt-10 mb-6 space-x-2 text-green-800"><p>API by</p>  <a class="underline hover:text-blue-600" href="https://covid19api.com/">https://covid19api.com/</a></div>
